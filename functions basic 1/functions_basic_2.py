...
# new list that counts down by one, from the number (as the 0th element) down to
...
#     if old_list[1] > old_list[1]:
#         new_list.append(old_list[1])
#     if old_list[2] > old_list[1]:
#         new_list.append(old_list[2])
#     if old_list[3] > old_list[1]:
#         new_list.append(old_list[3])
#     if old_list[4] > old_list[1]:
#         new_list.append(old_list[4])
#     if old_list[5] > old_list[1]:
#         new_list.append(old_list[5])


# old_list = [5, 2, 3, 2, 1, 4]
# new_list = []
# values_greater_than_second(old_list)
# print(new_list)
